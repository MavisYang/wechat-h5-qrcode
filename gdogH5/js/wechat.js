...
function wechat_login() {
    ...
    if(code===null){
        ...
        location.href = `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${APP_ID}&redirect_uri=${escape(location.href)}&response_type=code&scope=snsapi_base&connect_redirect=1#wechat_redirect`
    }else {
